...
> How do I convert Roman Numerals?

**A:** To read a Roman Numeral (e.g., XXV), we use I, V, X, L, C and M to simbolize 1, 5, 10, 50, 100, 500 and 1000 respectively. Then, they're written from the largest to the smallest, left to right, so 'XXV' correspondes to 'X(10)' + 'X(10)' + 'V(5)' = '25'. 
